...
shutil.copy('./build/examples/Problem03FreelyTranlatingBodyFrameEquationsRigidBody3D', output_dir)

# executable args
cli_args = ' '.join(element.split("=")[1] for element in sys.argv[2:])
os.system('cd ' + output_dir + '&& ./Problem03FreelyTranlatingBodyFrameEquationsRigidBody3D ' + cli_args)
